...
namespace AutoDiff
{
    ...
    public abstract class Term
    {
        ...
        public static Term operator/(Term left, double right)
        {
            return TermBuilder.Product(left, 1.0 / right);
        }
        ...
        /// <summary>
        /// Constructs a difference of a term and a scalar
        /// </summary>
        /// <param name="left">The first term in the difference</param>
        /// <param name="right">The second term in the difference.</param>
        /// <returns>A term representing <paramref name="left"/> - <paramref name="right"/>.</returns>
        ...
        {
            return TermBuilder.Exp(term);
        }

        public static Term Log(Term term)
        {
            return TermBuilder.Log(term);
        }
